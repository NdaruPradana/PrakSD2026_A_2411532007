...
public class JamDriver2_2411532007 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n --- Input Jam 1 ---");
		Jam_2411532007 j1 = buatJamDariInput(input);
		
		System.out.println("\n --- Input Jam 2 ---");
		Jam_2411532007 j2 = buatJamDariInput(input);
		...
		System.out.println("Durasi (J1 ke J2)         :" + Jam_2411532007.durasiDetik(j1, j2) + "detik");
		
		Jam_2411532007 jNext = j1.nextSeconds();
		System.out.println("Jam 1 Detik Berikutnya:" + jNext);
		
		Jam_2411532007 jPrev = j1.prevSeconds();
		System.out.println("Jam 1 Detik Berikutnya:" + jPrev);
		
		Jam_2411532007 jHasilPlus = j1.plus(j2);
	...
	private static Jam_2411532007 buatJamDariInput(Scanner sc) {
		int h, m, s;
		while(true) {
			...
			if (Jam_2411532007.isValid(h, m, s))
