...
public class JamDriver2_2411532007 {
	public static void main(String[] args ) {
		...
		// 1. Input Jam Pertama
		System.out.println("\n--- Input Jam 1 ---");
		jam_2411532007 jl = buatJamDariInput(input);
		...
		int perbandingan = jl.compareTo(j2);
		if (perbandingan > 0) {
